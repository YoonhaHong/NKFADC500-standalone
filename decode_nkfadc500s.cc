...
//	cout << "DLen1: " << DLen << " DLen2: " << DLen2 << endl;
	cout << "DLen: " << DLen << endl;
	cout << "nADC: " << nADC << endl;
	cout << "nTDC: " << nTDC << endl;
	...
	{
		in.open(Form("%s/%s_%d.dat", FPath, FName, RunNo), std::ios::binary);
		if (!in.is_open()) { cout << Form("%s/%s_%d_%d.dat", FPath, FName, RunNo, i+1) << endl;  cout <<"Cannot open the file! Stop.\n"; return 1; }
